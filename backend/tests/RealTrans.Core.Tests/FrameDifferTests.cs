...
namespace RealTrans.Core.Tests
{
    public class FrameDifferTests
    {
        ...
        public void LargeChange_IsNotSimilar()
        {
            ...
            // Every byte swings by the full range -> change ratio = 1.0, far above the 5% threshold.
        ...
        public void SubThresholdChange_IsStillSimilar()
        {
            ...
            // Flip a single byte by the full range: diff/(100*255) ~= 0.01, under the 5% threshold.
